...
const DICT = {
  zh: {
    ...
    desktop_search_hint: '輸入後，下方名單會即時篩選。Enter 開啟結果，Esc 清除。',
    search_clear: '清除搜尋',
    loading_data: '載入資料中…',
    ...
    map_error_desc: '可能是網絡連接受限或底圖暫時無法載入。列表、搜尋與篩選仍可使用。',
  ...
  pt: {
    ...
    desktop_search_hint: 'A lista filtra ao escrever. Enter abre o resultado, Esc limpa.',
    ...
    map_error_desc: 'A ligação pode estar limitada ou o mapa indisponível. A lista, a pesquisa e os filtros continuam disponíveis.',
  ...
  en: {
    ...
    desktop_search_hint: 'The list filters as you type. Enter opens a result, Esc clears.',
    ...
    map_error_desc: 'The connection may be limited or the basemap unavailable. The list, search and filters still work.',
